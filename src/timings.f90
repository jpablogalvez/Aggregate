...
!
       ...
       real(kind=8)  ::  tshift    !  Total state-shift time
       ...
       real(kind=8)  ::  trepscrn  !  Total representation screening time
       real(kind=8)  ::  tiso      !  Total graph-isomorphism time
!
       ...
       real(kind=8)  ::  tcpushift !  Total CPU state-shift time
       ...
       real(kind=8)  ::  tcpurepscrn !  Total CPU representation screening time
       real(kind=8)  ::  tcpuiso   !  Total CPU graph-isomorphism time
!
